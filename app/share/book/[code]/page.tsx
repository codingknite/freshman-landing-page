...
export default async function ShareBookPage({
  ...
  const deepLink = `freshman:///share/book/${code}`;
    ...
    <div className='min-h-screen bg-background'>
      ...
      <main className='max-w-5xl mx-auto px-6 pt-16 pb-0 text-center'>
        ...
        <h1 className='text-5xl sm:text-6xl lg:text-6xl font-medium leading-[1.1] tracking-tight mb-6'>
          Someone shared a textbook with you
        </h1>

        {/* Subtitle */}
        <p className='text-md sm:text-md text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed'>
          Open in the Freshman app to start reading.<br className='hidden sm:block' />
          Study smarter with AI-powered chapter summaries.
        </p>
